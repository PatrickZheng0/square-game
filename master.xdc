...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { clk_100mHzin }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
create_clock -period 20.000 -name sys_clk_pin -waveform {0.000 10.000} -add [get_ports clk_100mHzin]
...
##Buttons
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { anti_reset }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
